package com.harbourperformance;
 ...
 */
public final class HarbourPerformance implements ClientModInitializer {
    private static final String NAME = "HarbourPerformance";
    ...
    private static final KeyMapping TOGGLE = new KeyMapping(
            "key.harbourperformance.toggle", GLFW.GLFW_KEY_F8,
            "category.harbourperformance");
    private static final KeyMapping ADAPTIVE = new KeyMapping(
            "key.harbourperformance.adaptive", GLFW.GLFW_KEY_F9,
            "category.harbourperformance");
